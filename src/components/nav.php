...
<div class="navbar bg-neutral text-neutral-content px-2 gap-2 md:gap-0 md:px-4">
    ...
    <div class="dropdown">
      ...
      <ul tabindex="0" class="menu menu-sm ml-0 dropdown-content mt-3 z-[1] p-2 pb-4 shadow bg-base-100 rounded-box w-64">
        ...
        echo isset($_SESSION['user'])
          ...
          '
          : '
          <li><a href="./src/public/account/login.php" class="text-neutral-content">Logiun</a></li>
  ...
  <div class="hidden flex-1 justify-end gap-4 md:flex">
    ...
    echo isset($_SESSION['user'])
      ...
      '
    : '
    <a href="./src/public/account/login.php" class="btn btn-primary">Logion</a>
    <a href="./src/public/account/register.php" class="btn btn-secondary">Register</a>
    '; ?>
  </div>
</div>
