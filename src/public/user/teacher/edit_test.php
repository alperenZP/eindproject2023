            ...
            <?php
                for ($y = 0; $y < count($questions); $y++) {
                    ...
                    <div class="card w-96 bg-base-100 shadow-xl">
                        <div class="card-body">
                            <h2 class="card-title">Vraag '.$ynum.'</h2><a href="https://bibliotheek.live/alperenGit/src/lib/user/teacher/delete_question.php?questionid='.$questions[$y]["id"].'"><button class="btn btn-error">❌</button></a>
