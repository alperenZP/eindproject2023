...
<div class="min-h-[100svh] w-full flex flex-col justify-center items-center p-8">
    ...
    if ((isset($_POST["submit"]) || isset($_GET["x"]) || isset($_GET["y"])) && $_SESSION["has_refreshed"] == 0) {
        $_SESSION["has_refreshed"] = 1;
        if ($_SESSION["position_in_test"] < count($questions)) {
            ...
            echo '
                <form action="" method="post"
                    ...
                    <button name="submit" class="btn btn-primary mb-6">Probeer de test opnieuw</button>
        ...
        echo '
                <form action="" method="post"
                    ...
                    <div class="flex flex-col gap-4">
                        <div class="mockup-window border bg-base-300">
                            <div class="flex justify-center px-4 py-16 bg-base-200">Deze test bestaat uit '.count($questions).' vragen met drie onjuiste keuzes en één juiste keuze.</div>
                        </div>
                    </div>
            
                    <button name="submit" class="btn btn-primary mb-6">Begin toets</button>
